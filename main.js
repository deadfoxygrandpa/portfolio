...
Elm.ColorScheme.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Color = F2(function (a,b) {    return {color: a,hex: b};});
   var highlight1 = A2(Color,A3($Color.rgb,80,227,194),"#50e3c2");
   var highlight2 = A2(Color,A3($Color.rgb,248,231,28),"#f8e71c");
   var background = A2(Color,A3($Color.rgb,242,249,250),"#f2f9fa");
   var accent1 = A2(Color,A3($Color.rgb,184,233,134),"#b8e986");
   var accent2 = A2(Color,A3($Color.rgb,245,166,35),"#f5a623");
   var accent3 = A2(Color,A3($Color.rgb,74,144,226),"#4a90e2");
   var accent4 = A2(Color,A3($Color.rgb,155,155,155),"#9b9b9b");
   var randomColor = function () {
      var choose = function (n) {
         return _U.eq(n,0) ? accent1 : _U.eq(n,1) ? accent2 : _U.eq(n,
         2) ? accent3 : _U.eq(n,3) ? accent4 : _U.eq(n,
         4) ? highlight1 : highlight2;
      };
      return A2($Random.map,choose,A2($Random.$int,0,5));
   }();
...
Elm.Material = Elm.Material || {};
Elm.Material.Icons = Elm.Material.Icons || {};
Elm.Material.Icons.Navigation = Elm.Material.Icons.Navigation || {};
Elm.Material.Icons.Navigation.make = function (_elm) {
   "use strict";
   _elm.Material = _elm.Material || {};
   _elm.Material.Icons = _elm.Material.Icons || {};
   _elm.Material.Icons.Navigation = _elm.Material.Icons.Navigation || {};
   if (_elm.Material.Icons.Navigation.values)
   return _elm.Material.Icons.Navigation.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Svg = Elm.Svg.make(_elm);
   var _op = {};
   var unfold_more = $Material$Icons$Internal.icon("M12 5.83L15.17 9l1.41-1.41L12 3 7.41 7.59 8.83 9 12 5.83zm0 12.34L8.83 15l-1.41 1.41L12 21l4.59-4.59L15.17 15 12 18.17z");
   var unfold_less = $Material$Icons$Internal.icon("M7.41 18.59L8.83 20 12 16.83 15.17 20l1.41-1.41L12 14l-4.59 4.59zm9.18-13.18L15.17 4 12 7.17 8.83 4 7.41 5.41 12 10l4.59-4.59z");
   var refresh = $Material$Icons$Internal.icon("M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z");
   var more_vert = $Material$Icons$Internal.icon("M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z");
   var more_horiz = $Material$Icons$Internal.icon("M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z");
   var menu = $Material$Icons$Internal.icon("M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z");
   var fullscreen_exit = $Material$Icons$Internal.icon("M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z");
   var fullscreen = $Material$Icons$Internal.icon("M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z");
   var expand_more = $Material$Icons$Internal.icon("M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z");
   var expand_less = $Material$Icons$Internal.icon("M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z");
   var close = $Material$Icons$Internal.icon("M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z");
   var chevron_right = $Material$Icons$Internal.icon("M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z");
   var chevron_left = $Material$Icons$Internal.icon("M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z");
   var check = $Material$Icons$Internal.icon("M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z");
   var cancel = $Material$Icons$Internal.icon("M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z");
   var arrow_forward = $Material$Icons$Internal.icon("M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z");
   var arrow_drop_up = $Material$Icons$Internal.icon("M7 14l5-5 5 5z");
   var arrow_drop_down_circle = $Material$Icons$Internal.icon("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 12l-4-4h8l-4 4z");
   var arrow_drop_down = $Material$Icons$Internal.icon("M7 10l5 5 5-5z");
   var arrow_back = $Material$Icons$Internal.icon("M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z");
   var apps = $Material$Icons$Internal.icon("M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4h-4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4h-4v4zm0 6h4v-4h-4v4z");
   return _elm.Material.Icons.Navigation.values = {_op: _op
                                                  ,apps: apps
